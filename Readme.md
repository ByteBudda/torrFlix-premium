...
torrFLIX — это современный веб-сервис
для просмотра фильмов и сериалов через торренты.
 Приложение интегрируется с TMDB (The Movie Database)
для получения метаданных и с Jackett/Prowlarr для поиска торрент-раздач.
